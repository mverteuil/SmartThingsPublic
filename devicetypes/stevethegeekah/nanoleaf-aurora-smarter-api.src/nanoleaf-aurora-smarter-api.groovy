...
metadata {
	...
	tiles(scale:2) {
        multiAttributeTile(name:"switch", type: "lighting", decoration: "flat", canChangeIcon: true, width: 6, height: 4) {
		...
		standardTile("scene1", "scene1", decoration: "flat", width: 3, height: 1) {
            state "val", label: '${currentValue}', backgroundColor: "#ffffff", action: "setScene1" 
        }
        
        standardTile("scene2", "scene2", decoration: "flat", width: 3, height: 1) {
            state "val", label: '${currentValue}', backgroundColor: "#ffffff", action: "setScene2" 
		}
		
        standardTile("scene3", "scene3", decoration: "flat", width: 3, height: 1) {
            state "val", label: '${currentValue}', backgroundColor: "#ffffff", action: "setScene3" 
        }
		
        standardTile("scene4", "scene4", decoration: "flat", width: 3, height: 1) {
            state "val", label: '${currentValue}', backgroundColor: "#ffffff", action: "setScene4" 
        }
        
		standardTile("previousScene", "scene", decoration: "flat", width: 1, height: 1) {
		...
		valueTile("currentScene", "scene", decoration: "flat", width: 4, height: 1) {
			state "val", label: '${currentValue}', backgroundColor: "#ffffff"
		} 

		standardTile("nextScene", "scene", decoration: "flat", width: 1, height: 1) {
        ...
        main "switch"
        details(["switch","scene1","scene2","scene3","scene4","previousScene","currentScene","nextScene","refresh"])
    }
